# BIOMD0000000515: MODEL1401310002
...
`pip install git+https://github.com/biomodels/BIOMD0000000515.git`

To install a specific version (in this example, from the 2014-09-16 BioModels release)

`pip install git+https://github.com/biomodels/BIOMD0000000515.git@20140916`

## Usage

Importing the model package.

`import BIOMD0000000515 as model`
...
and its subsequent utilizing reactions. This model correspond to Model C-fruc
of the paper.
...
and identified by:
[BIOMD0000000515](http://identifiers.org/biomodels.db/BIOMD0000000515) .
